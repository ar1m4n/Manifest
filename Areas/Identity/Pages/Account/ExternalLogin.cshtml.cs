...
namespace Manifest.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class ExternalLoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string remoteError = null)
        {
            ...
            var fbProfilePic = info.Principal.FindFirstValue(ClaimTypes.NameIdentifier);
            fbProfilePic = $"https://graph.facebook.com/v4.0/{fbProfilePic}/picture";
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        if(info.Principal.HasClaim(a => a.Type == ClaimTypes.Name))
                        {
                            await _userManager.AddClaimAsync(user, info.Principal.FindFirst(a => a.Type == ClaimTypes.Name));
                        }
